...
class des(_baseDes):
    ...
    def __create_sub_keys(self):
        ...
        while i < 16:
            ...
            i += 1
        # for current_round_key in range(len(self.Kn)):
        #     current_round_key_string = self.__BitList_to_String(self.Kn[current_round_key])
        #     print(f"Round key {current_round_key + 1}: {current_round_key_string.hex().upper()}")
...
plain = b"12345678"
algo = des(b"Password", ECB, b"\0\0\0\0\0\0\0\0")
cipher = algo.encrypt(plain)
print("Cipher (DES2): ", cipher.hex().upper()) 